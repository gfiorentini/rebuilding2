...
var idps = [{ "organization_name": "ArubaPEC S.p.A.", "entity_id": "https://loginspid.aruba.it", "logo_uri": "../../../images/spid/spid-idp-arubaid.svg" }, { "organization_name": "InfoCert S.p.A.", "entity_id": "https://identity.infocert.it", "logo_uri": "../../../images/spid/spid-idp-infocertid.svg" }, { "organization_name": "Lepida S.p.A.", "entity_id": "https://id.lepida.it/idp/shibboleth", "logo_uri": "../../../images/spid/spid-idp-lepida.svg" }, { "organization_name": "Namirial", "entity_id": "https://idp.namirialtsp.com/idp", "logo_uri": "../../../images/spid/spid-idp-namirialid.svg" }, { "organization_name": "Poste Italiane SpA", "entity_id": "https://posteid.poste.it", "logo_uri": "../../../images/spid/spid-idp-posteid.svg" }, { "organization_name": "Sielte S.p.A.", "entity_id": "https://identity.sieltecloud.it", "logo_uri": "../../../images/spid/spid-idp-sielteid.svg" }, { "organization_name": "Register.it S.p.A.", "entity_id": "https://spid.register.it", "logo_uri": "../../../images/spid/spid-idp-spiditalia.svg" }, { "organization_name": "TI Trust Technologies srl", "entity_id": "https://login.id.tim.it/affwebservices/public/saml2sso", "logo_uri": "../../../images/spid/spid-idp-timid.svg" }, { "organization_name": "TeamSystem s.p.a.", "entity_id": "https://spid.teamsystem.com/idp", "logo_uri": "../../../images/spid/spid-idp-teamsystemid.svg" }]
...
function spid_addIdpEntry(data, element) {
  ...
  if (element.id.indexOf('get') !== -1) {
    li.innerHTML = `<a href="javascript: void(0);" onclick="accessoAUTHSERVICE(\'SPID\',\'${data['entity_id']}\')"><span class="spid-sr-only">${data['organization_name']}</span><img src="${data['logo_uri']}" alt="${data['organization_name']}" /></a>`
  };
  element.prepend(li)
}
