...
class CNS {
	...
	public function __construct() {
		...
		//$fldwsdl_url="https://authservice.comune-online.it/AuthService/services/AuthService?wsdl";
		//$fldwsdl_url="https://spid.comune-online.it/AuthServiceCNS/services/AuthService?wsdl";
		$fldwsdl_url="https://autenticazione.comune-online.it/AuthServiceCNS/services/AuthService?wsdl";
	...
	public function retrieveUserData($authId){
		...
		/*
		echo "<pre>";
		echo "REQUEST:\n".htmlentities(str_replace("&#13;","",str_replace("&gt;",">",str_replace("&lt;","<",$this->soapClient->__getLastRequest()))))."\n";
		echo "</pre>";
		echo "<br><br>";
		*/
