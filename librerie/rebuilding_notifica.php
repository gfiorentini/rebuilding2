...
<html lang="it">
  ...
  <body class="bg-light">
    ...
    $aBREADCUMB[2]["titolo_pagina"]="Notifiche";
    $aBREADCUMB[2]["url"]="notifiche";

    $aBREADCUMB[3]["titolo_pagina"]="Notifica";
    $aBREADCUMB[3]["url"]="";
                ...
                <form id="NOTIFICAFORM" name="NOTIFICAFORM" method="post" role="form" enctype="multipart/form-data" onsubmit="return doOnSubmit()">
                  ...
                  <div class="form-group row">
                    <div class="col-12 col-md-12">
                        ...
                        <select class="selectpicker" multiple id="formENTEselect" name="formENTEselect" title="Centro territoriale/ATS*" <?php echo $disabled_notifica;?> >
